...
<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=DM+Mono:wght@400;500&display=swap" media="print" onload="this.media='all'">
<noscript><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=DM+Mono:wght@400;500&display=swap"></noscript>
  ...
  <div style="max-width:720px;margin:0 auto" id="faqList">
    ...
    $faqs = [
      ...
      ['Bagaimana sistem pricing-nya? Saya bingung soal coin.',
       'Simpel: <strong>1× aktivasi Rp 800rb per outlet</strong> (promo launching) untuk akses permanen, sisanya pay-per-use via Coin. Saat aktivasi dapat <strong>100.000 coin bonus</strong> — plus sisa coin trial kamu otomatis ditambahkan ke saldo. Contoh harga fitur: buat nota = 50 coin, kirim nota via WA = 100 coin, AI Chat = 50 coin. Topup self-service mulai Rp 20rb (1 coin = Rp 1, bonus s.d. 15%). <strong>Tidak ada langganan bulanan wajib</strong> — kamu yang kontrol pemakaian.'],
