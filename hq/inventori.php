  ...
  <div id="hq-tab-pivot" class="hq-tab-content">
    <div style="overflow-x:auto">
      <table class="pivot-table" id="pivotTable">
        ...
        <tbody><tr><td style="padding:0"><div class="lm-loading"><span class="lm-loader" style="--sz:52px"><span class="lm-ring"></span><img class="lm-logo" src="/assets/loader-logo.png?v=<?= @filemtime(ROOT . '/assets/loader-logo.png') ?: date('Ymd') ?>" alt=""></span><span>Memuat data…</span></div></td></tr></tbody>
      </table>
    </div>
    ...
    <div style="overflow-x:auto">
      <table class="pivot-table">
        ...
        <tbody id="hqAlertBody">
          <tr><td colspan="6" style="padding:0"><div class="lm-loading"><span class="lm-loader" style="--sz:52px"><span class="lm-ring"></span><img class="lm-logo" src="/assets/loader-logo.png?v=<?= @filemtime(ROOT . '/assets/loader-logo.png') ?: date('Ymd') ?>" alt=""></span><span>Memuat data…</span></div></td></tr>
        </tbody>
      </table>
    </div>
  </div>
