...
<style>
.inv-hq-summary{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin-bottom:20px}
...
.inv-hq-num{font-size:clamp(0.8rem,3.4vw,1.4rem);white-space:nowrap;letter-spacing:-0.02em;font-weight:800;color:#0F1C3A;font-family:'DM Mono',monospace;margin-bottom:4px}
...
@media (max-width:640px){
  .inv-hq-summary{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin-bottom:16px}
  .inv-hq-card{padding:12px}
  .inv-hq-num{font-size:clamp(0.75rem,3.4vw,1.2rem)}
  ...
  <div id="hq-tab-pivot" class="hq-tab-content">
    <div style="overflow-x:auto">
      <table class="pivot-table" id="pivotTable">
        ...
        <tbody><tr><td style="padding:0"><div class="lm-loading"><span class="lm-loader" style="--sz:52px"><span class="lm-ring"></span><img class="lm-logo" src="/assets/loader-mark.png" alt=""></span><span>Memuat data…</span></div></td></tr></tbody>
      </table>
    </div>
    ...
    <div style="overflow-x:auto">
      <table class="pivot-table">
        ...
        <tbody id="hqAlertBody">
          <tr><td colspan="6" style="padding:0"><div class="lm-loading"><span class="lm-loader" style="--sz:52px"><span class="lm-ring"></span><img class="lm-logo" src="/assets/loader-mark.png" alt=""></span><span>Memuat data…</span></div></td></tr>
        </tbody>
      </table>
    </div>
  </div>
