...
async function loadList(){
  const r = await fetch('/hq/roles.php?action=list');
...
async function loadPermsCache(){
  ...
  const r = await fetch('/hq/roles.php?action=permissions_grouped');
...
async function openEdit(id){
  const r = await fetch('/hq/roles.php?action=detail&id=' + id);
