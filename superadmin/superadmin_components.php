...
function saRenderHead(string $title = 'Super Admin'): void {
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @media (max-width: 900px) {
      ...
      .sa-content { padding: 40px 18px 36px; }  /* beri jarak dari sticky topbar (60px) */
...
function saRenderNav(string $activePage = '', string $pageTitle = ''): void {
    ...
    <aside class="sa-sidebar" id="saSidebar">
      ...
      <nav class="sa-sidebar-nav">
        ...
        <a href="/superadmin/tenant_health.php" class="sa-nav-link <?= $activePage === 'tenant_health' ? 'active' : '' ?>">
          <span class="icon">🩺</span> Tenant Health
        </a>
        <a href="/superadmin/leads.php" class="sa-nav-link <?= $activePage === 'leads' ? 'active' : '' ?>">
