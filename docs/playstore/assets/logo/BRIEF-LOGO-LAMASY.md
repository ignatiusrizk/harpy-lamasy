# Brief Desain Logo LAMASY (untuk Canva)

Dokumen ini untuk dikerjakan di Canva. Tujuannya: logo LAMASY yang **jelas satu
keluarga** dengan **Harpy** dan **Harpy Laundry** — bukan konsep baru.

---

## 1. Konteks keluarga (WAJIB dijaga)
...
## 2. Elemen visual (tiru gaya Harpy Laundry)
...
> ciri keluarga Harpy justru pada kesederhanaan teal-putih.

---

## 4. Tipografi

- **Wordmark "LAMASY":** sans-serif **bold**, geometris & bersih. Di Canva cari yang
  mirip: **Poppins SemiBold/Bold, Montserrat Bold, Nunito Sans Bold, atau Archivo
  Bold**. Huruf kapital semua, tracking (jarak huruf) +5% s/d +10%.
- Hindari serif untuk wordmark (serif hanya milik logo induk "H").

---

## 5. Komposisi (tata letak dalam lingkaran)
...
**Ukuran ekspor:** PNG latar transparan, **1024×1024** (dan 512×512). Untuk Play
Store butuh **512×512**.
