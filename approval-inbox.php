...
.inbox-tabs{display:flex;justify-content:space-between;gap:2px;margin-bottom:14px;border-bottom:2px solid #E5E7EB;overflow-x:auto;-webkit-overflow-scrolling:touch}
.inbox-tabs::-webkit-scrollbar{display:none}
.tab-btn{flex:0 0 auto;background:none;border:none;padding:10px 10px;font-size:13px;color:#6B7280;cursor:pointer;border-bottom:3px solid transparent;font-weight:600;white-space:nowrap;text-align:center;-webkit-tap-highlight-color:transparent;outline:none;-webkit-appearance:none}
